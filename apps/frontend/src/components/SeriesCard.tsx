...
const SeriesCard: React.FC<SeriesCardProps> = ({
  ...
  return (
    <Link href={`/series/${id}`} className="group relative rounded-xl overflow-hidden bg-card border border-border/50 shadow-lg hover:shadow-orange-500/20 transition-all duration-300 hover:-translate-y-1 block">
