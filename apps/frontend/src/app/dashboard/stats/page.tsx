    ...
    return (
        <div className="space-y-8 fade-in-up">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                <div className="bg-card border border-border rounded-2xl p-6 flex items-center gap-4 transition-all duration-500 stagger-1 shadow-sm hover:shadow-md hover:border-orange-500/50 hover:-translate-y-[2px]">
                    <div className="w-12 h-12 rounded-xl bg-orange-500/10 flex items-center justify-center text-orange-500 transition-transform duration-300 hover:scale-110">
                ...
                <div className="bg-card border border-border rounded-2xl p-6 flex items-center gap-4 transition-all duration-500 stagger-2 shadow-sm hover:shadow-md hover:border-orange-500/50 hover:-translate-y-[2px]">
                    <div className="w-12 h-12 rounded-xl bg-orange-500/10 flex items-center justify-center text-orange-500 transition-transform duration-300 hover:scale-110">
                        <Users size={24} />
                    </div>
                    <div>
                ...
                <div className="bg-card border border-border rounded-2xl p-6 flex items-center gap-4 transition-all duration-500 stagger-3 shadow-sm hover:shadow-md hover:border-orange-500/50 hover:-translate-y-[2px]">
                    <div className="w-12 h-12 rounded-xl bg-orange-500/10 flex items-center justify-center text-orange-500 transition-transform duration-300 hover:scale-110">
                        <Star size={24} />
                    </div>
                    <div>
                ...
                <div className="bg-card border border-border rounded-2xl p-6 flex items-center gap-4 transition-all duration-500 stagger-4 shadow-sm hover:shadow-md hover:border-orange-500/50 hover:-translate-y-[2px]">
                    <div className="w-12 h-12 rounded-xl bg-orange-500/10 flex items-center justify-center text-orange-500 transition-transform duration-300 hover:scale-110">
                        <BarChart3 size={24} />
                    </div>
                    <div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 pt-4">
                {/* Top Movies */}
                <div className="bg-card border border-border rounded-2xl p-6 flex flex-col transition-all duration-500 stagger-5 shadow-sm hover:shadow-md hover:border-orange-500/30">
                                    ...
                                    <div key={movie.id} className="relative z-10 flex flex-col p-3 rounded-lg bg-background border border-border hover:bg-orange-500/5 transition-all duration-300 shadow-sm">
                                        <div className="flex items-center justify-between">
                                            <div className="flex items-center gap-3">
                                                <div className="flex items-center justify-center w-6 h-6 rounded-full bg-orange-500/10 text-orange-500 font-bold text-xs">
                                                    {idx + 1}
                                                </div>
                                        ...
                                        <div className="mt-3 flex items-center gap-3 w-full">
                                            <div className="flex-1 bg-orange-500/10 rounded-full h-2 overflow-hidden flex">
                                                <div
                ...
                {/* Top Reviewers */}
                <div className="bg-card border border-border rounded-2xl p-6 flex flex-col transition-all duration-500 stagger-6 shadow-sm hover:shadow-md hover:border-orange-500/30">
                    <div className="flex items-center gap-3 mb-6 border-b border-border pb-4">
                        ...
                        <div className="space-y-4">
                            {(() => {
                                ...
                                return topReviewers.map((reviewer: any, idx: number) => (
                                    <div key={reviewer.id} className="relative z-10 flex flex-col p-3 rounded-lg bg-background border border-border hover:bg-orange-500/5 transition-all duration-300 shadow-sm">
                                        <div className="flex items-center gap-3">
                                            <div className="flex items-center justify-center w-6 h-6 rounded-full bg-orange-500/10 text-orange-500 font-bold text-xs">
                                                {idx + 1}
                                            </div>
                                        ...
                                        <div className="mt-3 flex items-center gap-3 w-full">
                                            ...
                                            <p className="text-xs font-bold w-16 text-right text-orange-500">{reviewer.reviewCount} <span className="text-muted-foreground font-normal">revs</span></p>
                                        </div>
                                    </div>
                                ));
                            })()}
